      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl p-12 mb-20 border border-blue-100 transform hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] transition-all duration-500">
          ...
          <form onSubmit={(e) => {
            ...
            >
              <Eye className="inline-block mr-3 h-6 w-6 group-hover:animate-bounce" />
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-2xl overflow-hidden relative animate-fadeIn">
            <div className="p-8 border-b border-gray-200 flex justify-between items-center bg-gradient-to-r from-blue-600 to-blue-800 text-white">
              <h3 className="text-2xl font-bold">Gamepass Önizleme</h3>
              <button
              ...
              {isLoadingPreview ? (
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 p-6 rounded-xl">
                    <h4 className="text-xl font-bold text-blue-900 mb-4">{gamepassDetails.name}</h4>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">{gamepassDetails.price} R$</span>
                      </div>
                      <div className="flex justify-between items-center">
